...
const tick = () =>
{
    ...
    if (tmp[tmp.length-1] == 'history.html') {
        ...
        if (elapsedTime > dictTimes["Scene1"]) {
            ...
            scene.getObjectByName('face-left').position.copy(new THREE.Vector3(-2, -3, 0))
            scene.getObjectByName('face-right').position.copy(new THREE.Vector3(11, -3, 0))

            opacityAnimation(scene.getObjectByName('face-left'), elapsedTime, startTime, startTime+1)
            opacityAnimation(scene.getObjectByName('face-right'), elapsedTime, startTime, startTime+1)
        }        
        // -------------------- Scene 1.1
        ...
        if (elapsedTime > dictTimes["Scene2"]) {
            ...
            lerpAnimation(camera, new THREE.Vector3(90, -20, 100), elapsedTime, startTime, startTime+2)
            lerpAnimation(scene.getObjectByName('face-left'), new THREE.Vector3(-2, 0.8, -5), elapsedTime, startTime, startTime+2)
            lerpAnimation(scene.getObjectByName('face-right'), new THREE.Vector3(11, 0.8, -5), elapsedTime, startTime, startTime+2)

            scene.getObjectByName('face-left-chin').visible = true;
            lerpAnimation(scene.getObjectByName('face-left-chin'), scene.getObjectByName('face-left').position, elapsedTime, startTime, startTime+2)

            scene.getObjectByName('face-right-chin').visible = true;
            lerpAnimation(scene.getObjectByName('face-right-chin'), scene.getObjectByName('face-right').position, elapsedTime, startTime, startTime+2)
        ...
        if (elapsedTime > dictTimes["Scene3"]) {
            ...
            lerpAnimation(camera, new THREE.Vector3(-80, 0, 90), elapsedTime, startTime, startTime+2)  
            
            lerpAnimation(scene.getObjectByName('face-left'), new THREE.Vector3(-2, 0, -15), elapsedTime, startTime, startTime+2)
            lerpAnimation(scene.getObjectByName('face-right'), new THREE.Vector3(11, 0, -15), elapsedTime, startTime, startTime+2)
            ...
            lerpAnimation(scene.getObjectByName('face-left-profile'), scene.getObjectByName('face-left').position, elapsedTime, startTime, startTime+2)
            lerpAnimation(scene.getObjectByName('face-right-profile'), scene.getObjectByName('face-right').position, elapsedTime, startTime, startTime+2)
        ...
        if (elapsedTime > dictTimes["Scene31"]) {
            ...
            lerpAnimation(camera, new THREE.Vector3(20, 0, 80), elapsedTime, startTime, startTime+2)  

            scene.getObjectByName('face-left-profile').visible = false;
            scene.getObjectByName('face-right-profile').visible = false;

            lerpAnimation(scene.getObjectByName('face-left'), new THREE.Vector3(-10, 0.8, -15), elapsedTime, startTime, startTime+2)
            lerpAnimation(scene.getObjectByName('face-right'), new THREE.Vector3(8, 0.8, -15), elapsedTime, startTime, startTime+2)
